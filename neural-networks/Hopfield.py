...
class HopfieldNetwork:
    ...
    def recall(self, pattern, max_iterations=20, threshold=0):
        """
...
# Example usage with 2x2 grid patterns (similar to your MLP example)
...
def test_hopfield_network():
    ...
    visualize_patterns([bipolar_to_binary(noisy_pattern1), bipolar_to_binary(noisy_pattern2)], ['Noisy Top', 'Noisy Bottom'])
    ...
    visualize_patterns([bipolar_to_binary(recalled_pattern1), bipolar_to_binary(recalled_pattern2)], ['Recalled Top', 'Recalled Bottom'])
